...
//    MaxentTagger tagger = new MaxentTagger(args[0]);
    MaxentTagger tagger = new MaxentTagger("src/taggers/models/english-left3words-distsim.tagger");

    TokenizerFactory<CoreLabel> ptbTokenizerFactory = PTBTokenizer.factory(new CoreLabelTokenFactory(),
									   "untokenizable=noneKeep");
//    BufferedReader r = new BufferedReader(new InputStreamReader(new FileInputStream(args[1]), "utf-8"));
    BufferedReader r = new BufferedReader(new InputStreamReader(new FileInputStream("src/taggers/sample-input.txt"), "utf-8"));
